  ...
  <div>
      ...
      <el-row>
        <el-col :span="20">
          ...
          <el-input
            ...
            clearable
          ></el-input>
          <el-select v-model="searchModel.userreviewstatus" placeholder="请选择审核状态">
             <el-option label="全部" value=""></el-option>
             <el-option label="未审核" value="0"></el-option>
             <el-option label="已审核" value="1"></el-option>
             <el-option label="已禁用" value="2"></el-option>
          </el-select>
          <el-select v-model="searchModel.roleid" placeholder="请选择权限等级">
            <el-option label="全部" value=""></el-option>
    ...
    <el-card>
      <el-table :data="userList" border style="width: 100%">
        ...
        <el-table-column prop="roleid" label="账户权限" width="180">
          <template slot-scope="scope">
            <el-tag
            ...
            <el-tag
              v-else-if="scope.row.roleid === 2"
              type="success"
            >
              管理员
            </el-tag>
            <el-tag
              v-else-if="scope.row.roleid === 3"
              type="danger"
            >
              用户
            </el-tag>
    ...
    >
      <el-form :model="userForm" ref="userFormRef" :rules="rules">
        ...
        <el-form-item label="权限等级" :label-width="formLabelWidth">
          <el-select v-model="userForm.roleid" placeholder="请选择权限等级">
             <el-option label="超级管理员" value="1"></el-option>
             <el-option label="管理员" value="2"></el-option>
             <el-option label="普通用户" value="3"></el-option>
          </el-select>
