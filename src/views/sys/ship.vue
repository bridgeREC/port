  ...
  <div>
    ...
    <el-card>
      <el-table :data="shipList" border style="width: 100%">
        ...
        <el-table-column prop="id" label="船舶ID" width="80">
        </el-table-column>
    ...
    >
      <el-form :model="shipForm" ref="userFormRef" :rules="rules">
        ...
        <el-form-item label="船东姓名" :label-width="formLabelWidth">
          ...
          <el-form-item label="船舶状态" :label-width="formLabelWidth">
          <el-select v-model="shipForm.reviewstatus" placeholder="请选择船舶状态">
             <el-option label="未审核" value="0"></el-option>
